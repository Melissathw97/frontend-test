...
const EditBookForm = ({ book, toggleModal, editBookHandler }) => {
  ...
  const { id, title, serialNo, genre, author, publishedYear, fiction, coverPhoto } = book;
  ...
  const [bookDetails, setBookDetails] = useState({
    ...
    genre: genre.id,
    publishedYear,
    fiction: fiction.toString(),
    coverPhoto: { label: "", value: coverPhoto }
  })
  ...
  const onSubmitHandler = (e) => {
    ...
    const { id, title, fiction, genre, author, coverPhoto, serialNo, publishedYear } = bookDetails;
    ...
    updateBook({
      ...
      toast.success(`${book.title} succesfully edited`)
